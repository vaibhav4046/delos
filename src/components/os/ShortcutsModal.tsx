...
const SHORTCUTS: Array<{ keys: string; desc: string; section: string }> = [
  ...
  { keys: "⌘ Shift B", desc: "Open VibeCode (app builder)", section: "Global" },
  { keys: "⌘ Shift D", desc: "Run 60-second judge demo", section: "Global" },
  { keys: "⌘ G", desc: "Tile all windows", section: "Window" },
  { keys: "⌘ Shift C", desc: "Cascade all windows", section: "Window" },
  ...
  { keys: "Enter", desc: "Run mission in Terminal · build in VibeCode", section: "Apps" },
