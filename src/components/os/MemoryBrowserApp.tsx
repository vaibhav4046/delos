...
// R11b · default to `demo_guest` so guest mode never sees an empty
...
function readTenant(): string {
  if (typeof window === "undefined") return "demo_guest";
  try {
...
export function MemoryBrowserApp() {
  ...
  // dashboard's first load() fires against `demo_guest`, triggering
